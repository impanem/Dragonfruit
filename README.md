...
Similiarly to the Single Image, to have a Slideshow, add images to the Slideshow folder (user_slideshow_images).
...
After selecting your video and playing it, you can then adjust the Audio Bus, Volume, Nute, Pause, and Play the video.
...
Your addons directory should look like this:
```
res://
    addons
        Dragonfruit
